-- Express Powerr Solutions - Seed Data
-- Compatible with both SQLite and PostgreSQL

INSERT OR IGNORE INTO clients (id, name, short_code, tin, sst_reg_no) VALUES
...
INSERT OR IGNORE INTO client_sites (id, client_id, name, address, latitude, longitude, geofence_radius_m) VALUES
...
INSERT OR IGNORE INTO vehicles (id, plate_no, vehicle_type, make_model, year, can_bus_supported, tank_capacity_l) VALUES
  ('v0000001-0000-0000-0000-000000000001', 'WXX 1234', 'prime_mover',   'Scania R460',        2022, 1, 400),
  ('v0000001-0000-0000-0000-000000000002', 'WXX 5678', 'prime_mover',   'Volvo FH500',         2021, 1, 450),
  ('v0000001-0000-0000-0000-000000000003', 'WXX 9012', 'crane_truck',   'Hino 700 Series',     2023, 1, 300),
  ('v0000001-0000-0000-0000-000000000004', 'WXX 3456', 'crane_truck',   'Isuzu Giga',          2020, 1, 280),
  ('v0000001-0000-0000-0000-000000000005', 'WXX 7890', 'low_loader',    'Trailer (40ft)',      2022, 0, NULL),
  ('v0000001-0000-0000-0000-000000000006', 'WXX 2345', 'low_loader',    'Trailer (20ft)',      2021, 0, NULL),
  ('v0000001-0000-0000-0000-000000000007', 'WXX 6789', 'service_van',   'Toyota Hiace',        2023, 0, 70),
  ('v0000001-0000-0000-0000-000000000008', 'WXX 0123', 'service_van',   'Mitsubishi L300',     2019, 0, 55);

INSERT OR IGNORE INTO generators (id, serial_no, brand, model, voltage_rating, power_kva, ble_beacon_id, status) VALUES
...
INSERT OR IGNORE INTO employees (id, name, role, cert_number, phone, email) VALUES
...
INSERT OR IGNORE INTO users (id, username, password_hash, employee_id, role) VALUES
...
INSERT OR IGNORE INTO geofences (id, name, geofence_type, latitude, longitude, radius_m, client_site_id) VALUES
...
INSERT OR IGNORE INTO trip_jobs (id, job_number, client_id, site_id, site_address, job_type, status,
  ...
  ('j0000001-0000-0000-0000-000000000001', 'JOB-2026-0001',
   ...
   '2026-07-15 08:30:00', '2026-07-15 09:15:00', '2026-07-15 14:00:00'),
...
INSERT OR IGNORE INTO fuel_logs (id, vehicle_id, trip_job_id, litres, probe_reading_pct, gps_lat, gps_lon,
  ...
  ('fl000001-0000-0000-0000-000000000001', 'v0000001-0000-0000-0000-000000000001',
   ...
   'PETRONAS-20260715-001', 'Petronas', '2026-07-15 08:45:00'),
  ('fl000001-0000-0000-0000-000000000002', 'v0000001-0000-0000-0000-000000000001',
   ...
   'PETRONAS-20260715-002', 'Petronas', '2026-07-15 12:30:00'),
  ('fl000001-0000-0000-0000-000000000003', 'v0000001-0000-0000-0000-000000000003',
   ...
   'SHELL-20260723-001', 'Shell', '2026-07-23 07:15:00');

INSERT OR IGNORE INTO geofence_events (id, geofence_id, vehicle_id, event_type, gps_lat, gps_lon, event_at) VALUES
  ('ge000001-0000-0000-0000-000000000001', 'f0000001-0000-0000-0000-000000000002',
   'v0000001-0000-0000-0000-000000000001', 'entry', 3.0500, 101.4500, '2026-07-15 09:10:00'),
  ('ge000001-0000-0000-0000-000000000002', 'f0000001-0000-0000-0000-000000000002',
   'v0000001-0000-0000-0000-000000000001', 'exit',  3.0510, 101.4510, '2026-07-15 14:05:00');
